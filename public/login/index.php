...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // 1) AD-autentisering (skal fungere som før)
        ...
        // 2) Forsøk å synke bruker til MySQL (skal IKKE stoppe innlogging hvis DB feiler)
        try {
    ...
    <style>
        ...
        * {
        ...
        button[type="submit"]:hover {
            ...
            box-shadow:
                0 18px 32px rgba(37, 99, 235, 0.45);
    ...
    <div class="card">
        ...
        <div class="form-pane">
            <div class="form-header">
                <h1>Velkommen!</h1>
                <p>Logg inn med brukernavn og passord fra domenet.</p>
            </div>
